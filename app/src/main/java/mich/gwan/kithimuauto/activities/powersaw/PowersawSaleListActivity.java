package mich.gwan.kithimuauto.activities.powersaw;
...
import mich.gwan.kithimuauto.adapters.pdf.PDFPowersaw;
import mich.gwan.kithimuauto.adapters.powersaw.PowersawSaleRecyclerAdapter;
import mich.gwan.kithimuauto.databinding.ActivityPowersawsalesListBinding;
...
public class PowersawSaleListActivity extends AppCompatActivity implements PDFPowersaw.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Kithimu_Auto/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_pwrsaw.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_kithimuauto_powersaw_sale_data.xls";
