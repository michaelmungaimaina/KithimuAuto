package mich.gwan.kithimuauto.activities.oil;
...
import mich.gwan.kithimuauto.activities.LoginActivity;
...
import mich.gwan.kithimuauto.adapters.oil.OilSaleRecyclerAdapter;
import mich.gwan.kithimuauto.adapters.pdf.PDFGas;
import mich.gwan.kithimuauto.adapters.pdf.PDFOil;
import mich.gwan.kithimuauto.databinding.ActivityOilsalesListBinding;
...
public class OilSaleListActivity extends AppCompatActivity implements PDFOil.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Kithimu_Auto/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_oil.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_kithimuauto_oil_sale_data.xls";
