package mich.gwan.kithimuauto.activities.spare;
...
import mich.gwan.kithimuauto.adapters.pdf.PDFSpare;
import mich.gwan.kithimuauto.adapters.spare.SpareSaleRecyclerAdapter;
import mich.gwan.kithimuauto.databinding.ActivitySparesalesListBinding;
...
public class SpareSaleListActivity extends AppCompatActivity implements PDFSpare.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Kithimu_Auto/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_spare.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_kithimuauto_spare_sale_data.xls";
