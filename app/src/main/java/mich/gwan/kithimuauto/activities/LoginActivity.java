package mich.gwan.kithimuauto.activities;
...
import mich.gwan.kithimuauto.activities.admin.ControlActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.textViewLinkRegister:
                ...
                Intent intentRegister = new Intent(getApplicationContext(), mich.gwan.kithimuauto.activities.RegisterActivity.class);
    ...
    private void verifyFromSQLite() {
        DbManagement dbm = new DbManagement();
            ...
            if (databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim(), textInputEditTextPassword.getText().toString().trim())) {
                ...
                Snackbar snackbar = Snackbar.make(nestedScrollView,  "Kithimu_Auto Session Opened Successfully", Snackbar.LENGTH_LONG);
