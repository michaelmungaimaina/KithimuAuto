package mich.gwan.kithimuauto.activities.bolt;
...
import mich.gwan.kithimuauto.activities.admin.ui.gallery.GalleryFragment;
import mich.gwan.kithimuauto.adapters.bolt.BoltSaleRecyclerAdapter;
import mich.gwan.kithimuauto.adapters.pdf.PDFBolt;
import mich.gwan.kithimuauto.adapters.pdf.PDFUtility;
import mich.gwan.kithimuauto.databinding.ActivityBoltssalesListBinding;
...
public class BoltSaleListActivity extends AppCompatActivity implements PDFBolt.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Kithimu_Auto/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_bolt.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_kithimuauto_bolt_sale_data.xls";
                    ...
                    if (froDatePicker.getText() == "" && toDatePicker.getText() == ""){
                        ...
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected void onPostExecute(Void aVoid) {
                                ...
                                textNetProfit.setText((String.valueOf(databaseHelper.getAllBoltSaleProfit())));
                                textNetTotal.setText(String.valueOf(databaseHelper.getAllBoltSaleTotal()));
                            }
                        }.execute();
                    }
                            ...
                            new AsyncTask<Void, Void, Void>() {
                                ...
                                protected void onPostExecute(Void aVoid) {
                                    super.onPostExecute(aVoid);
                                    recyclerAdapter.notifyDataSetChanged();
                                    textNetProfit.setText(String.valueOf(databaseHelper.getAllBoltSaleProfit((String) froDatePicker.getText())));
                                    textNetTotal.setText(String.valueOf(databaseHelper.getAllBoltSaleTotal((String) froDatePicker.getText())));
                                }
                            }.execute();
                    }
                            ...
                            new AsyncTask<Void, Void, Void>() {
                                ...
                                protected void onPostExecute(Void aVoid) {
                                    super.onPostExecute(aVoid);
                                    recyclerAdapter.notifyDataSetChanged();
                                    textNetProfit.setText(String.valueOf(databaseHelper.getAllBoltSaleProfit((String) froDatePicker.getText().toString(), (String) toDatePicker.getText().toString())));
                  ...
                  if(froDatePicker.getText() != "" && toDatePicker.getText() != "" ) {
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected void onPostExecute(Void aVoid) {
                                super.onPostExecute(aVoid);
                                recyclerAdapter.notifyDataSetChanged();
                                textNetProfit.setText(String.valueOf(databaseHelper.getAllBoltSaleProfit((String) froDatePicker.getText(), (String) toDatePicker.getText(), textInputEditText.getText().toString().toUpperCase())));
                            }
                        }.execute();
                    }
