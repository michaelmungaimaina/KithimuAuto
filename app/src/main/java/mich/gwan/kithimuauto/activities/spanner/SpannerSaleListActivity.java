package mich.gwan.kithimuauto.activities.spanner;
...
import mich.gwan.kithimuauto.adapters.pdf.PDFSpanner;
import mich.gwan.kithimuauto.adapters.spanner.SpannerSaleRecyclerAdapter;
import mich.gwan.kithimuauto.databinding.ActivitySpannersalesListBinding;
...
public class SpannerSaleListActivity extends AppCompatActivity implements PDFSpanner.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Kithimu_Auto/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_spanner.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_kithimuauto_spanner_sale_data.xls";
    ...
    private void getDataFromSQLite() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(Void aVoid) {
                super.onPostExecute(aVoid);
                recyclerAdapter.notifyDataSetChanged();
                textNetProfit.setText((String.valueOf(databaseHelper.getAllSpannerSaleProfit())));
                textNetTotal.setText(String.valueOf(databaseHelper.getAllSpannerSaleTotal()));
            }
        }.execute();
    }
