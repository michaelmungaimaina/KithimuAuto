package mich.gwan.kithimuauto.activities.admin.ui.gallery;
...
import mich.gwan.kithimuauto.adapters.AllSale.AllsaleRecyclerAdapter;
import mich.gwan.kithimuauto.adapters.pdf.PDFUtility;
import mich.gwan.kithimuauto.databinding.FragmentGalleryBinding;
...
public class GalleryFragment extends Fragment implements PDFUtility.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Kithimu_Auto/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_AllSales.pdf";
        }
        return path;
    }
   ...
   // private void deleteItem(int position) {
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_kithimuauto_allsale_data.xls";
